...
if __name__ == "__main__":
    ...
    rospy.loginfo("Moving to third intersection...")
    move_base.goto(0.05, -1.9, 0)

    rospy.loginfo("Moving to fourth intersection...")
    move_base.goto(1.4, 2.0, 0)
